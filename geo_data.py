"""
geo_data.py — Koordinat geografis 514 Kabupaten/Kota Indonesia
"""
...
COORDS: dict[str, tuple[float, float]] = {
    ...
    "Subulussalam": (2.6539, 98.0034),
    "Kota Banda Aceh": (5.5477, 95.3237), "Kota Langsa": (4.4683, 97.9706),
    "Kota Lhokseumawe": (5.1801, 97.1407), "Kota Sabang": (5.8930, 95.3215),
    "Kota Subulussalam": (2.6539, 98.0034),
    # ── SUMATERA UTARA ──
    ...
    "Natuna": (3.9915, 108.3212),
    "Kota Batam": (1.1301, 104.0529), "Kota Tanjungpinang": (0.9185, 104.4603),
    "Kota Tanjung Pinang": (0.9185, 104.4603),
    # ── JAMBI ──
    ...
    "Sarolangun": (-2.2930, 102.7101),
    "Tanjung Jabung Barat": (-1.3946, 103.5024),
    ...
    "Kota Lubuklinggau": (-3.2968, 102.8618),
    "Kota Pagar Alam": (-4.0285, 103.2491),
    "Kota Palembang": (-2.9761, 104.7754),
    "Kota Prabumulih": (-3.4258, 104.2352),
    # ── BANGKA BELITUNG ──
    ...
    "Kota Jakarta Barat": (-6.1681, 106.7591),
    "Kota Jakarta Pusat": (-6.1862, 106.8340),
    ...
    "Wonosobo": (-7.3617, 109.9036),
    "Kota Magelang": (-7.4722, 110.2175), "Kota Pekalongan": (-6.8886, 109.6753),
    "Kota Salatiga": (-7.3305, 110.5084), "Kota Semarang": (-6.9667, 110.4167),
    "Kota Surakarta": (-7.5755, 110.8243), "Kota Tegal": (-6.8797, 109.1256),
    # ── DI YOGYAKARTA ──
    ...
    "Tulungagung": (-8.0656, 111.9032),
    "Kota Blitar": (-8.0956, 112.1686), "Kota Kediri": (-7.8166, 112.0114),
    "Kota Madiun": (-7.6298, 111.5229), "Kota Malang": (-7.9666, 112.6326),
    "Kota Mojokerto": (-7.4716, 112.4337), "Kota Pasuruan": (-7.6456, 112.9080),
    "Kota Probolinggo": (-7.7544, 113.2156), "Kota Surabaya": (-7.2575, 112.7521),
    "Kota Batu": (-7.8681, 112.5270),
    # ── BALI ──
    ...
    "Sumba Timur": (-9.6600, 120.2600),
    "Timor Tengah Selatan": (-9.7500, 124.2900),
    "Timor Tengah Utara": (-9.4500, 124.4500),
    "Kota Kupang": (-10.1615, 123.5764),
    # ── KALIMANTAN BARAT ──
    ...
    "Kotawaringin Barat": (-2.5600, 111.7500),
    "Kotawaringin Timur": (-1.8300, 112.6000),
    ...
    "Hulu Sungai Tengah": (-2.5200, 115.5000),
    "Hulu Sungai Utara": (-2.0700, 115.2300),
    ...
    "Kota Banjarbaru": (-3.4426, 114.8322),
    "Kota Banjar Baru": (-3.4426, 114.8322),
    ...
    "Minahasa Utara": (1.6300, 125.1100),
    "Kota Bitung": (1.4415, 125.1918), "Kota Kotamobagu": (0.7267, 124.3167),
    "Kota Manado": (1.4748, 124.8421), "Kota Tomohon": (1.3228, 124.8290),
    # ── GORONTALO ──
    ...
    "Wakatobi": (-5.4400, 123.5800),
    "Kota Baubau": (-5.4686, 122.6278), "Kota Kendari": (-3.9985, 122.5130),
    # ── MALUKU ──
